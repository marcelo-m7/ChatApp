...
class WebScraper:
    ...
    def __init__(self, base_url: str, sitemap_url: str, output_folder: str, sub_folders=False) -> None:
        """
        ...
        - output_folder (str): The folder to save scraped data.
        """
...
def start_web_scraper(base_url='https://www.klarisana.com/',
                      ...
                      output_folder='Buffer/klarisana_web_scraper_files') -> None:
    """
    ...
    """
    try:
        scraper = WebScraper(base_url, sitemap_url, output_folder)
        scraper.process_site()
        print("Web scraping completed successfully.")
    except Exception as e:
        print(f"An error occurred: {e}")
        print(f"The path '{output_folder}' has not been changed.")
